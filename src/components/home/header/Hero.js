...
const Hero = () => {
	...
	return (
		<motion.div
			...
			initial={{ scale: 0 }}
			animate={{ scale: 1 }}
			transition={{ duration: 1.5, delay: 1, bounce: 0.25, type: 'spring' }}
		>
				...
				<h3 className="text-6xl font-light tracking-widest py-2"><span className="text-secondary">Software</span> <span className="text-gray">Engineer</span></h3>
				<p className=" text-gray text-2xl py-2 w-[90%]">
					...
					I'm currently working as a Frontend Developer at <Link to="https://elevatebits.com/">ElevateBits</Link>.
				</p>
				<div className="flex gap-10 text-4xl text-gray my-5">
					<motion.a 
				...
				<div className="flex gap-5">
					<Button to="/" className="text-2xl block">Download CV!</Button>
				</div>
		</motion.div>
	)
}
